...
import cn.toolq.qzone.adapter.menu.DrawerAdapter;
import cn.toolq.qzone.adapter.menu.DrawerItem;
import cn.toolq.qzone.adapter.menu.SimpleItem;
import cn.toolq.qzone.adapter.menu.SpaceItem;
import cn.toolq.qzone.base.BaseActivity;
import cn.toolq.qzone.common.ApiConst;
import cn.toolq.qzone.fragment.other.MyMsgFragment;
import cn.toolq.qzone.model.UserModel;
import cn.toolq.qzone.widget.GuideTipsDialog;
...
public class MainActivity extends BaseActivity implements DrawerAdapter.OnItemSelectedListener, ClickUtils.OnClick2ExitListener {
    ...
    private void initTab() {
        ...
        switchPage(MyMsgFragment.class);
    ...
    private void initSlidingMenu(Bundle savedInstanceState) {
        ...
        initDrawerHeader(mSlidingRootNav);
    ...
    private void initDrawerHeader(SlidingRootNav mSlidingRootNav) {
        ...
        OkHttpUtils.get()
                ...
                .execute(new BitmapCallback() {
                    ...
                    public void onResponse(Bitmap response, int id) {
                        UserModel.avatar = response;
                        avatarImageView.setImageBitmap(UserModel.avatar);
                    }
                });
