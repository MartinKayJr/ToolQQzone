...
package cn.toolq.qzone.fragment.components;
 ...
 */
public class MsgListOptionAdapter extends BroccoliRecyclerAdapter<MsgInfo> {
    ...
    protected int getItemLayoutId(int viewType) {
        return R.layout.adapter_msg_list_item;
    }
    ...
    @Override
    public XRecyclerAdapter refresh(Collection<MsgInfo> collection) {
        // 刷新时清除选中状态
        mSparseArray.clear();
        onAllSelectStatusChanged(false);
    ...
    @Override
    public XRecyclerAdapter loadMore(Collection<MsgInfo> collection) {
        onAllSelectStatusChanged(false);
